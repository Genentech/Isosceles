test_that("find_iso_switch works as expected", {
    ...
    expect_error(find_iso_switch(se = sce_copy),
                 ...
                 fixed = TRUE)
    expect_error(find_iso_switch(se = sce_transcript,
                                 cell_labels = NULL),
