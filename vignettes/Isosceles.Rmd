...
**WARNING: wf-single-cell currently seems to contain [a bug](https://github.com/epi2me-labs/wf-single-cell/issues/78) causing it to produce BAM files with incorrect alignments. Until the bug is fixed, we don't recommend using wf-single-cell results as an input for Isosceles.**
